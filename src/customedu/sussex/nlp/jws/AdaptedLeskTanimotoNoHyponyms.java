// Decompiled by DJ v3.7.7.81 Copyright 2004 Atanas Neshkov  Date: 11/01/2011 15.17.04
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   AdaptedLeskTanimotoNoHyponyms.java
...
public class AdaptedLeskTanimotoNoHyponyms
{
    ...
    public AdaptedLeskTanimotoNoHyponyms(IDictionary idictionary)
    {
        dict = null;
    ...
    public static void main(String args[])
    {
        ...
        AdaptedLeskTanimotoNoHyponyms adaptedlesktanimotonohyponyms = new AdaptedLeskTanimotoNoHyponyms(dictionary);
        double d = adaptedlesktanimotonohyponyms.lesk("cat", 1, "dog", 1, "n");
        ...
        System.out.println();
        TreeMap treemap = adaptedlesktanimotonohyponyms.lesk("cat", "dog", "n");
        ...
        System.out.println();
        double d1 = adaptedlesktanimotonohyponyms.max("cat", "dog", "n");
        System.out.println("max value");
        System.out.println(decimalformat.format(d1));
        System.out.println();
        TreeMap treemap1 = adaptedlesktanimotonohyponyms.lesk("cat", "dog", 2, "n");
        ...
        System.out.println();
        TreeMap treemap2 = adaptedlesktanimotonohyponyms.lesk("cat", 1, "dog", "n");
