...
public class Lesk1986GlossOverlaps {
	...
	public Lesk1986GlossOverlaps(IDictionary dict) {
		this.dict = dict;
	...
	public double overlap(String x, String y) {
		...
		for (List<String> o : store) {
			...
			{
				totalscore += (Math.pow((double) o.size(), 2.0)); // squre the
																	// length of
																	// the
																	// overlap
																	// and add
	...
	public static void main(String[] args) {
		...
		// ...................................................................................................................................................................................
		//String gloss1 = "The prejudice that members of one race are intrinsically superior to members of other races";
		//String gloss2 = "be fully aware or cognizant of";
		String gloss1 = "a member of the genus Canis (probably descended from the common wolf) that has been domesticated by man since prehistoric times; occurs in many breeds; \"the dog barked all night\"";
		String gloss2 = "a dog used in hunting game";
		Lesk1986GlossOverlaps lgo = new Lesk1986GlossOverlaps(ws.getDictionary());
		AdaptedLesk lesk = new AdaptedLesk(ws.getDictionary());
		...
		double score = lesk.lesk("dog", 1, "hunting_dog", 1, "n");
		double scores = lesk.max("dog", "hunting_dog", "n");
		TreeMap treemap = lesk.lesk("dog", "hunting_dog", "n");
